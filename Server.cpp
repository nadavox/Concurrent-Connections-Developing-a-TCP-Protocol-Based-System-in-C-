...
//        int bytes_sent = send(clientSock, buffer, strlen(buffer), 0);
//        if (bytes_sent < 0) {
...
//        while (true) {
//            int bytes_received = recv(clientSock, buffer, strlen(buffer), 0);
//            if (bytes_received == 0) {
//                // connection is closed
//                perror("Error the connection with the client is closed");
//                break;
...
//        bytes_sent = send(clientSock, buffer, Upload_Complete.size(), 0);
//        if (bytes_sent < 0) {
//            perror("Error sending the data to the client");
//            exit(1);
//        }
